...
* The approved smooth 练气十至十三层 `max_exp` values are
  `3,829 / 5,169 / 6,978 / 9,420`. Level 10 is
  `floor(2,553 × 1.5) = 3,829`; levels 11–13 then use iterative ×1.35 with
  flooring. Their cumulative cultivation totals from level 1 through the
  named target level are `11,293 / 16,462 / 23,440 / 32,860`, which fit the
  shared qi group's three/five/seven/nine-technique progression pattern.
...
Multiplier placement is deliberate: level 10 continues the prior ×1.5 curve,
then levels 11–13 use a smooth iterative ×1.35 curve instead of a separate
level-13 ×3 spike. The cumulative cultivation totals from level 1 through
levels 10/11/12/13 are 11,293 / 16,462 / 23,440 / 32,860, so
three/five/seven/nine mastered qi techniques respectively provide enough
backing within the nine-technique cap.
