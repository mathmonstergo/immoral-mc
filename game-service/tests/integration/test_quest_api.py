...
@pytest.mark.asyncio
async def test_provider_catalog_and_interaction_read_contract() -> None:
...
@pytest.mark.asyncio
async def test_full_quest_loop_returns_and_replays_frozen_http_bytes() -> None:
    async with app_client() as client:
...
@pytest.mark.asyncio
async def test_committed_domain_failure_is_replayed_as_the_same_http_response() -> None:
    async with app_client() as client:
...
@pytest.mark.asyncio
async def test_operation_id_reuse_with_a_different_fingerprint_conflicts() -> None:
    async with app_client() as client:
