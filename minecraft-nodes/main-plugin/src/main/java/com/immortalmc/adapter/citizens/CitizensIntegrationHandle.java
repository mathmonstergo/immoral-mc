...
public record CitizensIntegrationHandle(CitizensNpcResolver resolver, QuestNpcSource questNpcSource) {
    ...
    public static CitizensIntegrationHandle unavailable() {
        return new CitizensIntegrationHandle(CitizensNpcResolver.unavailable(), QuestNpcSource.unavailable());
    }
}
