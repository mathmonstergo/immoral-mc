...
class EntityTargetSelectorTest {
    ...
    void selectsVillagerHeightEntityWhenAimingAtBodyInsteadOfBasePoint() {
        EntityInteractionEntity villager = entity("30000000-0000-0000-0000-000000000001");
        ...
        Optional<EntityInteractionEntity> selected = selector.select(
                eye,
                bodyAim,
    ...
    void returnsEmptyWhenNoEntityBoundingBoxIntersectsViewRay() {
        ...
        Optional<EntityInteractionEntity> selected = selector.select(
                ...
                List.of(new EntityTargetCandidate(
                        entity("30000000-0000-0000-0000-000000000002"),
                        new BoundingBox(3.0, 0.0, 3.7, 3.6, 1.95, 4.3))));

        assertTrue(selected.isEmpty());
    }

    private static EntityInteractionEntity entity(String entityUuid) {
        return new EntityInteractionEntity(
                new EntityBinding("world", UUID.fromString(entityUuid)),
                "VILLAGER");
    }
}
